...
# PKS-SUBNET
"pas_subnet_1_cidrs: " + .modules[].outputs.pas_subnet_cidrs.value[0],
"pas_subnet_1_azname: " + .modules[].outputs.pas_subnet_availability_zones.value[0],
"pas_subnet_1_gateway: " + .modules[].outputs.pas_subnet_gateways.value[0],
"pas_subnet_1_ids: " + .modules[].outputs.pas_subnet_ids.value[0],
"pas_subnet_1_dns: " + "10.0.0.2",
"pas_subnet_1_range: " + "10.0.4.0-10.0.4.9",

"pas_subnet_2_cidrs: " + .modules[].outputs.pas_subnet_cidrs.value[1],
"pas_subnet_2_azname: " + .modules[].outputs.pas_subnet_availability_zones.value[1],
"pas_subnet_2_gateway: " + .modules[].outputs.pas_subnet_gateways.value[1],
"pas_subnet_2_ids: " + .modules[].outputs.pas_subnet_ids.value[1],
"pas_subnet_2_dns: " + "10.0.0.2",
"pas_subnet_2_range: " + "10.0.5.0-10.0.5.9",

"pas_subnet_3_cidrs: " + .modules[].outputs.pas_subnet_cidrs.value[2],
"pas_subnet_3_azname: " + .modules[].outputs.pas_subnet_availability_zones.value[2],
"pas_subnet_3_gateway: " + .modules[].outputs.pas_subnet_gateways.value[2],
"pas_subnet_3_ids: " + .modules[].outputs.pas_subnet_ids.value[2],
"pas_subnet_3_dns: " + "10.0.0.2",
"pas_subnet_3_range: " + "10.0.6.0-10.0.6.9",
